...
import "./styles/AdminPageNewDoctor.css";
import CustomTextField from "../authentication-page/custom/CustomTextField";
...
const ADD_NEW_DOCTOR_URL = BASE_URL + "/add-newdoctor";

const AdminPageNewDoctor = () => {
  // Name
  ...
  return (
    <div className="admin-page-new-doctor">
      <div className="main-section">
        <div className="top">
          <div className="h1-text">
            <h1 className="register-h1">Yeni Doktor Kaydı</h1>
          </div>
          {/*<div className="image">
...
export default AdminPageNewDoctor;
